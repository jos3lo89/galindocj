...
<head>
    ...
    <link rel="stylesheet" href="vista/bootstrap-css/bootstrap-icons.min.css">
...
<body>
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 colorcito rounded">
    ...
    <!-- color oscuro claro auto END-->

    <script src="vista/bootstrap-js/bootstrap.bundle.min.js"></script>
    <script src="vista/bootstrap-js/color-modes.js"></script>
    ...
    <script src="vista/js/registrar-revisor-ajax.js"></script>
    <script src="vista/js/pedirDatosUser-ajax.js"></script>
    <script src="vista/js/actualizarPerfil-ajax.js"></script>
    <script src="vista/js/mostrarInicioSobreMi-ajax.js"></script>
    <script src="vista/js/registrarHabilidad-ajax.js"></script>
    <script src="vista/js/registrarProyecto-ajax.js"></script>
